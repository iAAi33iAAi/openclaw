...
| crew-colony | Multi-agent crew with sovereign governance | Python | src/, tests/ |
...
| openclaw | Personal AI assistant platform -- customized for Alpha Intelligence governance | TypeScript | AGENTS.md, skills/, src/ |
...
2. Quibidt 1440 Treasury -- Decentralized currency system
3. World-Tribe Protocol -- Civilization OS smart contracts
4. Safety Kernel -- AI governance engine
5. Aethel Grid Validator -- Rust-based validation layer
6. ALEXARAC UI -- Sovereign platform dashboard
7. Platform Dashboard -- Operational monitoring
8. Undermoon OS -- Coordination substrate
9. Civics OS -- Governance interface

## Tech Stack Reference

- Python: safety-kernel (pytest, pyproject.toml), project-mono, World-Tribe-Protocol tests
