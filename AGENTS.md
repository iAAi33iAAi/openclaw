...
- Dependency-backed behavior: read upstream dependency docs/source/types first. Do not assume APIs, defaults, errors, timing, or runtime behavior.# AGENTS.md
...
This repo is the OpenClaw gateway layer of the Alpha Intelligence platform. Refer to the skill map for all repos:
...
- Commit Alpha Intelligence changes with prefix: `feat(ai):`, `fix(ai):`, `docs(ai):`
